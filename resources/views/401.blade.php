...
<html data-wf-page="648d0891096d52bfd9f271bc" data-wf-site="648d0891096d52bfd9f271dc" lang="fr">
<head>
  <meta charset="utf-8">
...
<body>
  <div class="utility-page-wrap">
    <div class="utility-page-content w-password-page w-form">
      <form action="/.wf_auth" method="post" id="email-form" name="email-form" data-name="Email Form" class="utility-page-form w-password-page" data-wf-page-id="648d0891096d52bfd9f271bc" data-wf-element-id="642f0ab16a398cfa7248cde200000000000c"><img src="images/-Funny-picture.webp" alt="" sizes="(max-width: 479px) 100vw, 260px" srcset="images/-Funny-picture-p-500.webp 500w, images/-Funny-picture-p-800.webp 800w, images/-Funny-picture.webp 1024w">
